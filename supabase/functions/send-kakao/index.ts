...
#{회원명}님, #{요청자명}님이 회원님의 프로필을 확인하고 친구 요청을 보냈습니다.
...
본 메시지는 고객님께서 골프피플 앱 [마이페이지 > 설정 > 알림 설정]에서 '친구 요청 알림' 수신을 직접 설정(ON)하신 경우에 한하여, 새로운 친구 요청이 접수될 때마다 발송됩니다. 수신을 원하지 않으시면 앱 내 알림 설정에서 해제하실 수 있습니다.`,
    buttonName: '앱에서 확인',
