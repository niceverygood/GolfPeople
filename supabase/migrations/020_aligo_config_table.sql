-- =============================================
-- Aligo API 키를 설정 테이블로 저장 (ALTER DATABASE 권한 불필요)
-- =============================================

-- 1. 설정 테이블 생성 (RLS로 직접 조회 차단)
...
-- 일반 사용자는 조회 불가 (SECURITY DEFINER 함수에서만 접근)
...
INSERT INTO app_config (key, value) VALUES
  ...
  ('aligo_sender', '01087399771')
ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value;

-- 3. send_kakao_alimtalk 함수 수정: current_setting → app_config 테이블
